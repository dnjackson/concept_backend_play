...
content_id: d66d275c7d0bd604da69dc61ecccb985272e4199eec775d780349eb42165de5a
---
...
export default class UserAuthConcept {
   ...
   *
   * **effects** returns an array containing the user document matching the given id, or an empty array if no user is found.
   */
  async _getUserById({ id }: { id: User }): Promise<UserDoc[]> {
   ...
   *
   * **effects** returns an array containing the user document matching the given username, or an empty array if no user is found.
   */
