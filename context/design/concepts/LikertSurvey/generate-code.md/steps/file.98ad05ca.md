---
timestamp: 'Sat Oct 11 2025 22:25:46 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251011_222546.ac9cd867.md]]'
content_id: 98ad05cad400f9209220f9e70fbadf6fbfc3a548cbf467610f4a9326561fc546
---
...
// Generic types used by this concept, following the specified convention.
type User = ID;
type Survey = ID;
type Question = ID;
type Response = ID;
...
export default class LikertSurveyConcept {
  ...
  constructor(private readonly db: Db) {
    this.surveys = this.db.collection<SurveyDoc>(`${PREFIX}.surveys`);
    this.questions = this.db.collection<QuestionDoc>(`${PREFIX}.questions`);
    this.responses = this.db.collection<ResponseDoc>(`${PREFIX}.responses`);
  }
   ...
   */
  async _analyzeSentiment({ question }: { question: Question }): Promise<{ sentiment: string }[]> {
...
That's good! I'm getting this error now though:

\[{
"resource": "/Users/dnj/Repos/concept\_backend\_play/src/concepts/LikertSurvey/LikertSurveyConcept.new.test.ts",
"owner": "*generated\_diagnostic\_collection\_name*#3",
"code": "no-import-prefix",
"severity": 4,
"message": "Inline 'npm:', 'jsr:' or 'https:' dependency not allowed\nAdd it as a dependency in a deno.json or package.json instead and reference it here via its bare specifier",
"source": "deno-lint",
"startLineNumber": 1,
"startColumn": 61,
"endLineNumber": 1,
